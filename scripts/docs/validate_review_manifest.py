...
REVIEW_GLOB = "docs/dia_sc_*review_*.md"
MANIFEST_DEFAULT = "docs/review_resource_manifest_20260312.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Optional manifest path. Defaults to docs/review_resource_manifest_20260312.json under repo root.",
    )

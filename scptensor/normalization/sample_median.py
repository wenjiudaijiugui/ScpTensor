...
def sample_median_normalization(
    ...
    # Calculate sample-wise medians and center
    ...
    container.log_operation(
        ...
        description=f"Sample median normalization on layer '{base_layer_name}' -> '{new_layer_name}'."
    )

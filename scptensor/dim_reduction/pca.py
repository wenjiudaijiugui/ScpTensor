...
def pca(
    ...
    >>> result = pca(container, "proteins", "imputed", n_components=10)
    >>> # Use specific solver
    >>> result = pca(container, "proteins", "imputed", svd_solver="randomized")
    """
    # ===== VALIDATION =====
...
__all__ = ["pca", "get_solver_info", "optimal_svd_solver"]

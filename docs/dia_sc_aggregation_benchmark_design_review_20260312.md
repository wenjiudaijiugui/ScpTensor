...
- 本综述本身不指定 `数据入口` 或 `资源包`；若需要稳定公开输入，应回到 `docs/dia_sc_public_benchmark_datasets_and_task_design_review_20260312.md` 中已收束的 public dataset / module 入口。
...
3. 在 `aggregation_methods_from_literature.md` 中补一节“benchmark interpretation”，把方法语义与评测标准分开。

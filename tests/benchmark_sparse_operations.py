...
def verify_no_densification():
    ...
    print(
        f"  After multiply:  {mem1['nbytes'] / 1024:.2f} KB ({mem1['nbytes'] / mem_before['nbytes']:.2f}x)"
    )
    print(
        f"  After log1p:     {mem2['nbytes'] / 1024:.2f} KB ({mem2['nbytes'] / mem_before['nbytes']:.2f}x)"
    )
    print(
        f"  After convert:   {mem3['nbytes'] / 1024:.2f} KB ({mem3['nbytes'] / mem_before['nbytes']:.2f}x)"
    )

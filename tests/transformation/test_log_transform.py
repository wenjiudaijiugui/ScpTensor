"""Tests for transformation.log_transform and normalization compatibility."""
...
def test_legacy_normalization_wrapper_warns() -> None:
    from scptensor.normalization.log_transform import log_transform as legacy_log_transform

    container = _make_container()
    with pytest.warns(DeprecationWarning):
        legacy_log_transform(container, assay_name="protein", source_layer="raw")
